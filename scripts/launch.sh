#!/bin/bash
# ABBY — infrastructure-agnostic training launcher
#
...
#   bash <(curl -s https://codeberg.org/Ronin48/ABBY/raw/branch/main/scripts/launch.sh)

set -e

REPO_URL="https://codeberg.org/Ronin48/ABBY.git"
REPO_NAME="ABBY"
...
ADAPTER_DIR="$REPO_DIR/output/abby-qlora/final"
HF_REPO="Ronin48LLC/abby-lora-adapter"
